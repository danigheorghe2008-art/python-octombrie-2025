...
# Task 5
# Implement a class Clock. Store the following in it: power type, manufacturer, year of manufacture, price,
#  type (digital, tabletop, wall, regulator, etc.)
#  Implement a constructor and class methods to input and output data, as well as other operations. Use method overloading.


# Task 6
# Implement a class Website. Store the following in it: website name, address, description.
#  Implement a constructor and class methods to input and output data, as well as other operations. Use method overloading.
