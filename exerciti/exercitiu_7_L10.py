...
# ***
# ***
size = int(input("Enter the size of the square (Task 1): "))
for _ in range(size):
    print("*" * size)
...
size = int(input("Enter the size of the square (Task 3): "))
for i in range(size):
    if i == 0 or i == size - 1:
        print("*" * size)
    else:
...
print("Task 4")
#  The user types in the length and width of a rectangle. Print an empty rectangle (only its sides are displayed).
